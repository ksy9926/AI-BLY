...
function LoginPage() {
    ...
    return (
        <Mobile>
            <Navbar />
            <Box
                className={classes.mobileAuthBox}
            >
                <form>
                    <Box className={classes.mobileInputBox}>
                        ...
                        />
                        <br />
                        <Button className={classes.mobileButton} variant="contained" onClick={onLoginHandler} >로그인</Button>
                    </Box>
                    <Box className={classes.mobileButtonBox}>
                        <Button className={classes.mobileButton} variant="contained" onClick={()=>{history.push({pathname:"/register"})}} >회원가입</Button>
                    </Box>
                </form>
            </Box>
        </Mobile>
